                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.deliverables.map((deliverable, idx) => (
                      ...
                      >
                        <Badge 
                          variant="outline" 
                          className="text-xs cursor-pointer hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:border-purple-600 dark:hover:border-purple-400 transition-all pr-6"
                        >
                          {deliverable.name}
                        </Badge>
                        <div className="absolute right-1.5 top-1/2 -translate-y-1/2 opacity-0 group-hover/badge:opacity-100 transition-opacity">
